                    ...
                    >
                      ...
                      <div className="flex gap-1.5 shrink-0">
                        ...
                        <button
                          ...
                          className="p-2 text-red-600 dark:text-red-400 bg-red-500/5 hover:bg-red-500/10 active:scale-[0.9] border border-red-500/10 rounded-xl transition duration-150 cursor-pointer min-h-[36px] min-w-[36px] flex items-center justify-center"
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  {supplierRows.map((supplier) => (
                    <div
                      key={supplier.id}
                      className="p-4 rounded-xl flex items-start justify-between gap-3 border transition-all duration-200 pos-panel hover:bg-foreground/[0.01]"
                    >
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="space-y-1 text-xs text-muted-foreground">
                          ...
                          {supplier.notes && (
                            <div className="flex items-start gap-1.5 mt-1 pt-1 border-t border-[var(--pos-stroke)]">
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <input
                id="sup-address"
                name="address"
                placeholder="e.g. Suraj Miani Road, Multan"
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-foreground/5 border border-foreground/10 rounded-xl px-4 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-pos-brand transition resize-none"
              />
            </div>
